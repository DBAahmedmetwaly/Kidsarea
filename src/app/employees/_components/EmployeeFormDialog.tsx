...
export default function EmployeeFormDialog({
    ...
    const [role, setRole] = useState<'مدير فرع' | 'كاشير' | 'مدير عام الفرع' | ''>('');
    ...
    const handleSubmit = () => {
        ...
        const requiresCredentials = role === 'كاشير' || role === 'مدير عام الفرع' || role === 'مدير فرع';
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto px-2">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                     ...
                     {(role === 'كاشير' || role === 'مدير عام الفرع' || role === 'مدير فرع') && (
                        <>
                            <div className="grid grid-cols-4 items-center gap-4">
